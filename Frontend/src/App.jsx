...
const App = () => {
  ...
  return loggedin ? (<div className={Style.mainBack}>
    <div className={Style.logoutmain}><Button className={Style.logout} style={{backgroundColor: "rgb(250, 64, 64)",color:"white"}} onClick={handleLogout}>Log Out</Button></div>
  </div>) : (
    <div className={Style.mainBack}>
      <div className={Style.main}>
        <Tabs isFitted variant='enclosed'>
          <TabList>
            <Tab className={Style.tabMain1} _selected={{ color: 'rgba(0, 0, 0, 0.721)', bg: 'rgba(0, 123, 255, 0.476)', fontSize: "1.3rem" }}>Login</Tab>
            <Tab className={Style.tabMain2} _selected={{ color: 'rgba(0, 0, 0, 0.721)', bg: 'rgba(0, 255, 68, 0.476)', fontSize: "1.3rem" }}>Signup</Tab>
          </TabList>
          ...
          <TabPanels>
            <TabPanel className={Style.form}>
              <form onSubmit={handleSubmitLogin}>
                ...
                <Input style={{ fontSize: "1.3rem", borderColor: "rgb(66, 66, 241)" }} onChange={handleChangeLogin} type="email" name='email' value={valueLogin.email} placeholder="Enter Email" />
                <p style={{ fontSize: "1.3rem" }}>Password</p>
                <Input style={{ fontSize: "1.3rem", borderColor: "rgb(66, 66, 241)" }} onChange={handleChangeLogin} type="password" name='password' value={valueLogin.password} placeholder="Enter Password" />
                <Input className={Style.submit1} style={{ fontSize: "1.3rem", borderColor: "green" }} type='submit' />
                <Security></Security>
              </form>
            </TabPanel>
            <TabPanel className={Style.form2}>
              <form onSubmit={handleSubmitSignup}>
                ...
                <Select name='securityQuestion' value={valueSignup.securityQuestion} onChange={handleChangeSignup} placeholder='Select a question of your choice' style={{ fontSize: "1.3rem", borderColor: "green" }}>
                ...
                <Input className={Style.submit2} style={{ fontSize: "1.3rem", borderColor: "green" }} type='submit' />
              </form>
            </TabPanel>
          </TabPanels>
        </Tabs>
